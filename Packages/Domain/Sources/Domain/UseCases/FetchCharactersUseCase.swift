...
public final class FetchCharactersUseCaseImpl: FetchCharactersUseCase {
    ...
    public func execute(page: Int, name: String?, status: String?, gender: String?) async throws -> CharacterList {
        try await repository.fetchCharacters(page: page, name: name, status: status, gender: gender)
    }
}
